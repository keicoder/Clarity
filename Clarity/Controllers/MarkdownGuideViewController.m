...
- (void)loadLocalFileIntoAWebView
{
    NSString *path;
    if (iPad) {
        path = [[NSBundle mainBundle] pathForResource:@"ClarityMarkdownSyntaxGuide_iPad" ofType:@"html" inDirectory:nil];
    } else {
        path = [[NSBundle mainBundle] pathForResource:@"ClarityMarkdownSyntaxGuide" ofType:@"html" inDirectory:nil];
    }
