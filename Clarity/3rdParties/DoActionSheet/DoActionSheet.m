...
- (void)setStyle
{
    self.doBackColor = [UIColor colorWithRed:0.953 green:0.957 blue:0.941 alpha:1];
    self.doButtonColor = [UIColor colorWithRed:0.333 green:0.693 blue:0.808 alpha:1.000]; //DO_RGB(52, 152, 219);
    self.doCancelColor = [UIColor colorWithRed:0.697 green:0.326 blue:0.265 alpha:1.000]; //DO_RGB(46, 204, 113); //DO_RGB(231, 76, 60);
    self.doDestructiveColor = [UIColor colorWithRed:0.636 green:0.599 blue:0.508 alpha:1.000]; //DO_RGB(231, 76, 60); //DO_RGB(46, 204, 113);
    ...
    self.doDimmedColor = DO_RGBA(0, 0, 0, 0.8);
    
    self.doTitleFont = [UIFont fontWithName:@"Avenir-Heavy" size:16];
    self.doButtonFont = [UIFont fontWithName:@"Avenir-Medium" size:16];
    self.doCancelFont = [UIFont fontWithName:@"Avenir-Medium" size:16];
    
    self.doTitleInset = UIEdgeInsetsMake(10, 20, 10, 20);
    self.doButtonInset = UIEdgeInsetsMake(5, 20, 5, 20);
    
    if (iPad) {
        self.doButtonHeight = 42.0f;
    } else {
        self.doButtonHeight = 42.0f;
    }
...
- (double)getTextHeight:(UILabel *)lbText
{
    ...
    else
    {
        ...
        if ([self respondsToSelector:@selector(boundingRectWithSize:options:attributes:context:)]) {
            ...
            size = [lbText.text boundingRectWithSize:CGSizeMake(lbText.frame.size.width, CGFLOAT_MAX)
